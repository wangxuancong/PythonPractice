...
# load dataset
train = loadtxt('output/naive_train.csv', delimiter=',')
test = loadtxt('output/naive_test.csv', delimiter=',')
...
save('airpre/supervised_train.npy', train_data)
save('airpre/supervised_test.npy', test_data)